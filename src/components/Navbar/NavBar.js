    ...
    >
      <div className="flex flex-row justify-between items-center py-2">
        <div className="flex flex-row justify-center md:px-12 md:mx-12 items-center text-center font-semibold">
          <img className="max-h-[10vh] pt-3" src={elevare} alt="logo" />
          <HashLink smooth to="/#hero" className="flex flex-row items-center">
            <h1 className="font-extrabold text-4xl text-[#efa63b]">Elevare</h1>
          </HashLink>
        </div>
